...
contract LocationPass is ERC721 {
    using Strings for uint256;

    string private _locationName;
    string private _passDisplayName;
    ...
    constructor(
        ...
        string memory locationName_,
        string memory passDisplayName_
    ) ERC721(name_, symbol_) {
        _locationName = locationName_;
        _passDisplayName = passDisplayName_;
    }
    ...
    function locationName() external view returns (string memory) {
        return _locationName;
    }

    function passDisplayName() external view returns (string memory) {
        return _passDisplayName;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory json = string(
            abi.encodePacked(
                ...
                '"},{"trait_type":"Pass Type","value":"Welcome"},{"trait_type":"Network","value":"Base"}]}'
            )
        );
    ...
    function _generateSVG(string memory tokenStr) internal view returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function _generateText(string memory tokenStr) internal view returns (string memory) {
        return string(
            abi.encodePacked(
                ...
                _passDisplayName,
                '</text>',
                '<text x="200" y="125" text-anchor="middle" fill="#3380FF" font-size="11" font-family="monospace" letter-spacing="3" opacity="0.7">',
                _locationName,
                '</text>',
